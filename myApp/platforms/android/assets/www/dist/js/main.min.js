var app=angular.module("app",["ionic"]);app.config(["$stateProvider","$urlRouterProvider",function(e,o){e.state("index",{url:"/index",templateUrl:"html/index.html",controller:"indexCtrl"}).state("detail",{url:"/detail/:type/:id",templateUrl:"html/detail.html",controller:"detailCtrl"}).state("index.a",{url:"/a",templateUrl:"html/indexA.html",controller:"indexActrl"}).state("index.b",{url:"/b",templateUrl:"html/indexB.html",controller:"indexBctrl"}).state("index.c",{url:"/c",templateUrl:"html/indexC.html",controller:"indexCctrl"}).state("index.d",{url:"/d",templateUrl:"html/indexD.html",controller:"indexDctrl"}).state("index.e",{url:"/e",templateUrl:"html/indexE.html",controller:"indexEctrl"}).state("index.f",{url:"/f",templateUrl:"html/indexF.html",controller:"indexFctrl"}).state("index.seach",{url:"/seach",templateUrl:"html/seach.html",controller:"indexSeach"}).state("index.collect",{url:"/collect",templateUrl:"html/collect.html",controller:"indexCollect"}),o.when("","/index/a")}]),app.controller("indexSeach",["$scope",function(e){e.name="设置页面路由"}]),app.controller("indexCollect",["$scope",function(e){e.name="conllect"}]),app.controller("indexCtrl",["$scope","$http","$rootScope",function(e,o,n){e.on=!0,console.log("执行了controller index的内容"),e.doRefresh=function(){console.log("执行了刷新 了"),e.arrs=[],o.get("http://route.showapi.com/109-35",{params:{showapi_appid:25350,showapi_sign:"5572a108b3cdc86cf39001cd",page:n.pageNum,needContent:1,maxResult:20}}).success(function(o){console.log(o),e.arrs=e.arrs.concat(o.showapi_res_body.pagebean.contentlist),e.news=e.arrs}).finally(function(){e.$broadcast("scroll.refreshComplete")})}}]),app.controller("detailCtrl",["$scope","$http","$state","$rootScope",function(e,o,n,c){switch(console.log("详情页"),e.channelId="",console.log(n.params),n.params.type){case"a":e.channelId="5572a108b3cdc86cf39001cd",console.log("a");break;case"b":e.channelId="5572a108b3cdc86cf39001cf",console.log("b");break;case"c":e.channelId="5572a109b3cdc86cf39001db",console.log("c");break;case"d":e.channelId="5572a108b3cdc86cf39001d3",console.log("d");break;case"e":e.channelId="5572a10bb3cdc86cf39001f6",console.log("e");break;case"f":e.channelId="5572a10bb3cdc86cf39001f7",console.log("f")}c.id=n.params.id,o.get("http://route.showapi.com/109-35",{params:{showapi_appid:25350,showapi_sign:"5572a108b3cdc86cf39001cd",channelId:e.channelId,needContent:1,maxResult:20}}).success(function(o){console.log(n.params.id),console.log(o.showapi_res_body.pagebean.contentlist),e.detail=o.showapi_res_body.pagebean.contentlist[n.params.id]})}]),app.controller("indexActrl",["$scope","$http","$rootScope","$state",function(e,o,n,c){e.pageNum=1,e.loading=!0,e.arrs=[],e.type=c.current.url,console.log(e.type),console.log("执行了indexA页面");var t=function(c){o.get("http://route.showapi.com/109-35",{params:{showapi_appid:25350,showapi_sign:"5572a108b3cdc86cf39001cd",page:e.pageNum,channelId:c,needContent:1,maxResult:20}}).success(function(o){e.loading=!1,n.channelId=o.showapi_res_body.pagebean.contentlist[0].channelId,console.log(n.channelId),e.arrs=e.arrs.concat(o.showapi_res_body.pagebean.contentlist),console.log(e.arrs),e.news=e.arrs})};e.loadMore=function(){console.log("click"),e.loading=!0,e.pageNum++,t("5572a108b3cdc86cf39001cd")},t("5572a108b3cdc86cf39001cd")}]),app.controller("indexBctrl",["$scope","$http","$rootScope","$state",function(e,o,n,c){e.pageNum=1,e.loading=!0,e.arrs=[],e.type=c.current.url,console.log(e.type),console.log("执行了indexB页面");var t=function(c){o.get("http://route.showapi.com/109-35",{params:{showapi_appid:25350,showapi_sign:"5572a108b3cdc86cf39001cd",page:e.pageNum,channelId:c,needContent:1,maxResult:20}}).success(function(o){e.loading=!1,n.channelId=o.showapi_res_body.pagebean.contentlist[0].channelId,console.log(n.channelId),e.arrs=e.arrs.concat(o.showapi_res_body.pagebean.contentlist),console.log(e.arrs),e.news=e.arrs})};e.loadMore=function(){console.log("click"),e.loading=!0,e.pageNum++,t("5572a108b3cdc86cf39001cf")},t("5572a108b3cdc86cf39001cf")}]),app.controller("indexCctrl",["$scope","$http","$rootScope","$state",function(e,o,n,c){e.pageNum=1,e.loading=!0,e.arrs=[],e.type=c.current.url,console.log(e.type),console.log("执行了indexA页面"),n.getNews=function(c){o.get("http://route.showapi.com/109-35",{params:{showapi_appid:25350,showapi_sign:"5572a108b3cdc86cf39001cd",page:e.pageNum,channelId:c,needContent:1,maxResult:20}}).success(function(o){e.loading=!1,n.channelId=o.showapi_res_body.pagebean.contentlist[0].channelId,console.log(n.channelId),e.arrs=e.arrs.concat(o.showapi_res_body.pagebean.contentlist),console.log(e.arrs),e.news=e.arrs})},n.loadMore=function(){console.log("click"),e.loading=!0,e.pageNum++,n.getNews("5572a109b3cdc86cf39001db")},n.getNews("5572a109b3cdc86cf39001db")}]),app.controller("indexDctrl",["$scope","$http","$rootScope","$state",function(e,o,n,c){e.pageNum=1,e.loading=!0,e.arrs=[],e.type=c.current.url,console.log(e.type),console.log("执行了indexA页面"),n.getNews=function(c){o.get("http://route.showapi.com/109-35",{params:{showapi_appid:25350,showapi_sign:"5572a108b3cdc86cf39001cd",page:e.pageNum,channelId:c,needContent:1,maxResult:20}}).success(function(o){e.loading=!1,console.log(o),n.channelId=o.showapi_res_body.pagebean.contentlist[0].channelId,e.arrs=e.arrs.concat(o.showapi_res_body.pagebean.contentlist),console.log(e.arrs),e.news=e.arrs})},n.loadMore=function(){console.log("click"),e.loading=!0,e.pageNum++,n.getNews("5572a108b3cdc86cf39001d3")},n.getNews("5572a108b3cdc86cf39001d3")}]),app.controller("indexEctrl",["$scope","$http","$rootScope","$state",function(e,o,n,c){e.pageNum=1,e.loading=!0,e.arrs=[],e.type=c.current.url,console.log(e.type),console.log("执行了indexA页面"),n.getNews=function(c){o.get("http://route.showapi.com/109-35",{params:{showapi_appid:25350,showapi_sign:"499321e69f444a25b436cafb9173f6c0",page:e.pageNum,channelId:c,needContent:1,maxResult:20}}).success(function(o){e.loading=!1,n.channelId=o.showapi_res_body.pagebean.contentlist[0].channelId,console.log(n.channelId),e.arrs=e.arrs.concat(o.showapi_res_body.pagebean.contentlist),console.log(e.arrs),e.news=e.arrs})},n.loadMore=function(){console.log("click"),e.loading=!0,e.pageNum++,n.getNews("5572a10bb3cdc86cf39001f6")},n.getNews("5572a10bb3cdc86cf39001f6")}]),app.controller("indexFctrl",["$scope","$http","$rootScope","$state",function(e,o,n,c){e.pageNum=1,e.loading=!0,e.arrs=[],e.type=c.current.url,console.log(e.type),console.log("执行了indexA页面"),n.getNews=function(c){o.get("http://route.showapi.com/109-35",{params:{showapi_appid:25350,showapi_sign:"499321e69f444a25b436cafb9173f6c0",page:e.pageNum,channelId:c,needContent:1,maxResult:20}}).success(function(o){e.loading=!1,n.channelId=o.showapi_res_body.pagebean.contentlist[0].channelId,console.log(n.channelId),e.arrs=e.arrs.concat(o.showapi_res_body.pagebean.contentlist),console.log(e.arrs),e.news=e.arrs})},n.loadMore=function(){console.log("click"),e.loading=!0,e.pageNum++,n.getNews("5572a10bb3cdc86cf39001f7")},n.getNews("5572a10bb3cdc86cf39001f7")}]),app.directive("xheader",function(){return{templateUrl:"html/xheader.html"}}),app.directive("xfooter",function(){return{templateUrl:"html/xfooter.html"}}),app.directive("xcontent",function(){return{templateUrl:"html/xcontent.html"}});
var app={initialize:function(){this.bindEvents()},bindEvents:function(){document.addEventListener("deviceready",this.onDeviceReady,!1)},onDeviceReady:function(){app.receivedEvent("deviceready")},receivedEvent:function(e){var t=document.getElementById(e),i=t.querySelector(".listening"),n=t.querySelector(".received");i.setAttribute("style","display:none;"),n.setAttribute("style","display:block;"),console.log("Received Event: "+e)}};app.initialize();
